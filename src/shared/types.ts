...
// Inferred Claude Code session activity from JSONL content
export type ClaudeSessionActivityType = "thinking" | "tool_use" | "idle";

export interface ClaudeSessionActivity {
  type: ClaudeSessionActivityType;
  toolNames?: string[]; // populated when type is "tool_use"
}
...
export interface ClaudeCodeLiveStats {
  ...
  idleSessions: number;
  sessionActivity?: ClaudeSessionActivity; // inferred from last JSONL line
